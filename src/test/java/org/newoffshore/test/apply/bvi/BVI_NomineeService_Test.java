...
import org.newoffshore.pages.apply.service.bvi.BVI_Nominee_Service;
...
public class BVI_NomineeService_Test {
    ...
    public void selectNomineeService(){
        ...
        bviGroupOfService.selectGroupNomineeDirectorship();

        BVI_Nominee_Service bviNomineeService = new BVI_Nominee_Service(driver);
        bviNomineeService.selectNomineeService();
