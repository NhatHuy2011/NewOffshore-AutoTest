...
import org.newoffshore.pages.apply.service.bvi.BVI_Continuation_Discontinuation_Service;
...
public class BVI_ContinueDiscontinueService_Test {
    ...
    @Test
    public void selectContinueDiscontinueService(){
        //Contact Information
        ...
        bviGroupOfService.selectGroupContinuation_DiscontinuationService();

        BVI_Continuation_Discontinuation_Service continuationDiscontinuationService = new BVI_Continuation_Discontinuation_Service(driver);
        continuationDiscontinuationService.selectContinuation_Discontinuation_Service();
