...
import org.newoffshore.pages.apply.service.bvi.BVI_RestoreCompany_Service;
...
public class BVI_RestoreCompany_Test {
    ...
    public void selectRestoreCompanyService(){
        ...
        BVI_RestoreCompany_Service bviRestoreCompanyService = new BVI_RestoreCompany_Service(driver);
        bviRestoreCompanyService.selectRestoreCompanyService();
